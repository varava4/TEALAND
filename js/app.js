(() => {
    ...
    function initSliders() {
        if (document.querySelector(".tea__slider")) new swiper_core_Swiper(".tea__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 3.5,
            ...
            loop: true,
            navigation: {
                prevEl: ".tea__button-slider--prev",
                nextEl: ".tea__button-slider--next"
            },
            breakpoints: {
                0: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".body-sometimes__slider")) new swiper_core_Swiper(".body-sometimes__slider", {
        ...
        if (document.querySelector(".gallery-big__slider")) {
            const bigSlider = new swiper_core_Swiper(".gallery-big__slider", {
            ...
            const smallSlider = new swiper_core_Swiper(".gallery__slider", {
